...
<div class="row">
    <div class="text-center">
        <img src="/resource/drawing/drawing_03.jpg" class="img-fluid" alt="Responsive image" usemap="#boardMap">
        <map name="boardMap">
            <area shape="rect" coords="83, 461, 242, 506" href="/drawing-worker" target="_self" onFocus="blur()"/>
        </map>
    </div>
</div>
