						...
						<tbody>
							<tr>
								...
								<td class="text-blue" colspan="3">
									<div class="PROGRAM ml-15 val_text" style="overflow-x: hidden;height: 75%;width: 98%;">
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="3">
									<div class="MESSAGE ml-15 val_text" style="overflow-x: hidden;height: 75%;width: 98%;">
									</div>
								</td>
							</tr>
						</tbody>
