    ...
    $(function () {
        ...
        const tab1ColModel = [
            ...
            {title: 'MCT Actual', align: 'center',
                colModel: [
                    {title: '1', minWidth: 50, width: 50, datatype: 'integer', dataIndx: 'WORK_EQUIP_ID_1'},
                    ...
                    {title: '2', minWidth: 50, width: 50, datatype: 'integer', dataIndx: 'WORK_EQUIP_ID_2'},
                    ...
                    {title: '3', minWidth: 50, width: 50, datatype: 'integer', dataIndx: 'WORK_EQUIP_ID_3'},
                    ...
                    {title: '4', minWidth: 50, width: 50, datatype: 'integer', dataIndx: 'WORK_EQUIP_ID_4'},
