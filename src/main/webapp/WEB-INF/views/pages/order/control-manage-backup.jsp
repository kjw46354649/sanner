                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="datePickerToday" name="CONTROL_MANAGE_START_DATE" id="CONTROL_MANAGE_START_DATE"
                                           readonly> ~
                                    <input type="text" class="datePickerToday" name="CONTROL_MANAGE_END_DATE" id="CONTROL_MANAGE_END_DATE" readonly>
...
<script>
    $(function () {
        ...
        let colModel = [
            ...
            {title: '설계자', dataType: 'string', dataIndx: 'DESIGNER_NM', editable: true, colModel: [], styleHead: {'font-weight': 'bold'}},
        ...
        const popupColModel = [
            ...
            {title: '품명', dataType: 'string', dataIndx: 'ITEM_NM', colModel: []},
            {
                ...
                render: function (ui) {
                    ...
                    console.log(index);
                    $orderRegisterGrid.pqGrid('updateRow', {'rowIndx': ui.rowIndx, row: {'WORK_CD': workType[index].value}});
