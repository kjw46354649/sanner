...
;(function ($, window, document, undefined) {
    ...
    ComboTree.prototype.init = function () {
        ...
        this._elemCloseBtn = $('<button id="' + this.comboTreeId + 'CloseBtn" class="comboTreeArrowBtn" type="button" style="right: 15.5%"><span class="comboTreeArrowBtnImg">×</span></button>');
        this._elemInput.after(this._elemCloseBtn);

        this._elemArrowBtn = $('<button id="' + this.comboTreeId + 'ArrowBtn" class="comboTreeArrowBtn" type="button"><span class="comboTreeArrowBtnImg">ˇ</span></button>');
        this._elemCloseBtn.after(this._elemArrowBtn);
    ...
    ComboTree.prototype.bindings = function () {
        ...
        this._elemCloseBtn.on('click', function (e) {
            e.stopPropagation();
